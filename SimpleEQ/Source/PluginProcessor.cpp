...
void SimpleEQAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
    ...
    updateCutCoefficients(rightLowCut, lowCutCoefficients, chainSettings.highCutSlope);

    
    //auto higCutCoefficients = juce::dsp::FilterDesign<float>::designIIRHighpassHighOrderButterworthMethod(
...
void SimpleEQAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
    ...
    updateCutCoefficients(rightLowCut, cutCoefficients, chainSettings.highCutSlope);
...
{
    auto peakCoefficient = juce::dsp::IIR::Coefficients<float>::makePeakFilter(
        getSampleRate(),
